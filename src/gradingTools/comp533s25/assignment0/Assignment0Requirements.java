...
public class Assignment0Requirements extends AJUnitProjectRequirements {
	public Assignment0Requirements() {
		...
		addDueDate("01/15/2025 01:00:00", 1.05);
		addDueDate("01/18/2025 01:00:00", 1.0);
		addDueDate("01/25/2025 01:00:00", 0.9);
		addDueDate("02/01/2025 01:00:00", 0.75);
        addFeature("Screenshots enclosed", 3, new DocumentEnclosedTestCase());
		addJUnitTestSuite(S25Assignment0Suite.class);
