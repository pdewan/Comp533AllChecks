...
public class Assignment1Requirements extends AJUnitProjectRequirements {
	public Assignment1Requirements() {
		...
		addDueDate("01/29/2025 01:00:00", 1.05);
		addDueDate("02/01/2025 01:00:00", 1.0);
		addDueDate("02/08/2025 01:00:00", 0.9);
		addDueDate("02/15/2025 01:00:00", 0.7);
		
		addJUnitTestSuite(S25Assignment1Suite.class);
