...
public class Assignment2Requirements extends AJUnitProjectRequirements {
	public Assignment2Requirements() {
		...
		addDueDate("02/12/2025 01:00:00", 1.05);
		addDueDate("02/15/2025 01:00:00", 1.0);
		addDueDate("02/22/2025 01:00:00", 0.9);
		addDueDate("03/01/2025 01:00:00", 0.7);
		
		addJUnitTestSuite(S25Assignment2Suite.class);
