...
public class Assignment5Requirements extends AJUnitProjectRequirements {
	public Assignment5Requirements() {
		...
		addDueDate("04/09/2025 01:00:00", 1.05);
		addDueDate("04/12/2025 01:00:00", 1.0);
		addDueDate("04/19/2025 01:00:00", 0.9);
		addDueDate("04/26/2025 01:00:00", 0.7);

		
		addJUnitTestSuite(S25Assignment5Suite.class);
