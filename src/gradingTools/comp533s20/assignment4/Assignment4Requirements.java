...
//		Tracer.setMaxTraces(4000);
		...
		addDueDate("03/25/2020 01:00:00", 1.05); // early extra
		//addDueDate("02/21/2020 01:00:00", 1.03); // other early extra
		addDueDate("03/27/2020 01:00:00", 1.0); // regular
		addDueDate("04/3/2020 01:00:00", 0.90); // one week late
		addDueDate("04/10/2020 01:00:00", 0.75); // two weeks late
