...
//		Tracer.setMaxTraces(4000);
		...
		//ExecutionSpecificationSelector.getExecutionSpecification().setSubDocuments(false);
		Comp533TraceUtility.setTurnOn(true);
		Comp533TraceUtility.setTracing();
		GraderTraceUtility.setTurnOn(true);
		GraderTraceUtility.setTracing();
		addDueDate("04/1/2020 01:00:00", 1.05); // early extra
		addDueDate("04/3/2020 01:00:00", 1.03); // other early extra
		addDueDate("04/6/2020 01:00:00", 1.0); // regular
		addDueDate("04/13/2020 01:00:00", 0.90); // one week late
