...
public class Assignment6Requirements extends AJUnitProjectRequirements {
	public Assignment6Requirements() {
		...
		addDueDate("04/10/2021 01:00:00", 1.05);
		addDueDate("04/15/2021 01:00:00", 1.0);
		addDueDate("04/22/2021 01:00:00", 0.9);
		addDueDate("04/29/2021 01:00:00", 0.75);		
		S21Assignment6Suite.configureProperties();
		addJUnitTestSuite(S21Assignment6Suite.class);
