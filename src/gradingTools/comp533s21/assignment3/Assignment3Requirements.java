...
public class Assignment3Requirements extends AJUnitProjectRequirements {
	public Assignment3Requirements() {
		...
		addDueDate("03/06/2021 01:00:00", 1.05);
		addDueDate("03/11/2021 01:00:00", 1.0);
		addDueDate("03/18/2021 01:00:00", 0.9);
		addDueDate("03/25/2021 01:00:00", 0.75);
		
		addJUnitTestSuite(S21Assignment3Suite.class);
