...
public class Assignment1Requirements extends AJUnitProjectRequirements {
	public Assignment1Requirements() {
		...
		addDueDate("01/30/2021 01:00:00", 1.05);
		addDueDate("02/04/2021 01:00:00", 1.0);
		addDueDate("02/11/2021 01:00:00", 0.9);
		addDueDate("02/18/2021 01:00:00", 0.75);
		
		addJUnitTestSuite(S21Assignment1Suite.class);
