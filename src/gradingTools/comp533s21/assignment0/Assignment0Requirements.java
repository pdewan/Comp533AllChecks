...
public class Assignment0Requirements extends AJUnitProjectRequirements {
	public Assignment0Requirements() {
		...
		addDueDate("01/23/2021 01:00:00", 1.05);
		addDueDate("01/27/2021 01:00:00", 1.0);
		addDueDate("02/04/2021 01:00:00", 0.9);
		addDueDate("02/11/2021 01:00:00", 0.75);
		
		addJUnitTestSuite(S21Assignment0Suite.class);
