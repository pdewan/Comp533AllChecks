...
public class Assignment4Requirements extends AJUnitProjectRequirements {
	...
	public Assignment4Requirements() {
		...
		addDueDate("03/20/2021 01:00:00", 1.05);
		addDueDate("03/25/2021 01:00:00", 1.0);
		addDueDate("04/01/2021 01:00:00", 0.9);
		addDueDate("04/08/2021 01:00:00", 0.75);
		
		addJUnitTestSuite(S21Assignment4Suite.class);
