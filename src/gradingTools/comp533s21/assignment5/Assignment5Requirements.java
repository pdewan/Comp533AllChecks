...
public class Assignment5Requirements extends AJUnitProjectRequirements {
	public Assignment5Requirements() {
		...
		addDueDate("03/27/2021 01:00:00", 1.05);
		addDueDate("04/01/2021 01:00:00", 1.0);
		addDueDate("04/08/2021 01:00:00", 0.9);
		addDueDate("04/15/2021 01:00:00", 0.75);		
		
		addJUnitTestSuite(S21Assignment5Suite.class);
