...
public class Assignment2Requirements extends AJUnitProjectRequirements {
	public Assignment2Requirements() {
		...
		addDueDate("02/12/2022 01:00:00", 1.05);
		addDueDate("02/16/2022 01:00:00", 1.0);
		addDueDate("02/23/2022 01:00:00", 0.9);
		addDueDate("03/02/2022 01:00:00", 0.75);
		
		addJUnitTestSuite(S22Assignment2Suite.class);
