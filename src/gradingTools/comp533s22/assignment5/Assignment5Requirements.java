...
public class Assignment5Requirements extends AJUnitProjectRequirements {
	public Assignment5Requirements() {
		...
		addDueDate("04/02/2022 01:00:00", 1.05);
		addDueDate("04/06/2022 01:00:00", 1.0);
		addDueDate("04/13/2022 01:00:00", 0.9);
		addDueDate("04/20/2022 01:00:00", 0.75);
		
		addJUnitTestSuite(S22Assignment5Suite.class);
