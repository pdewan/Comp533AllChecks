...
public class Assignment6Requirements extends AJUnitProjectRequirements {
	public Assignment6Requirements() {
		...
		addDueDate("04/14/2022 01:00:00", 1.05);
		addDueDate("04/20/2022 01:00:00", 1.0);
		addDueDate("04/27/2022 01:00:00", 0.9);
		addDueDate("05/04/2022 01:00:00", 0.75);
		
		addJUnitTestSuite(S22Assignment6Suite.class);
