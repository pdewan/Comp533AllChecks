...
public class Assignment3Requirements extends AJUnitProjectRequirements {
	public Assignment3Requirements() {
		...
		addDueDate("02/26/2022 01:00:00", 1.05);
		addDueDate("03/02/2022 01:00:00", 1.0);
		addDueDate("03/09/2022 01:00:00", 0.9);
		addDueDate("03/23/2022 01:00:00", 0.75);
		
		addJUnitTestSuite(S22Assignment3Suite.class);
