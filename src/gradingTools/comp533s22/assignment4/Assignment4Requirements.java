...
public class Assignment4Requirements extends AJUnitProjectRequirements {
	public Assignment4Requirements() {
		...
		addDueDate("03/23/2022 01:00:00", 1.05);
		addDueDate("03/26/2022 01:00:00", 1.0);
		addDueDate("04/02/2022 01:00:00", 0.9);
		addDueDate("04/09/2022 01:00:00", 0.75);
		
		addJUnitTestSuite(S22Assignment4Suite.class);
