...
public class Assignment0Requirements extends AJUnitProjectRequirements {
	public Assignment0Requirements() {
		...
		addDueDate("01/19/2024 01:00:00", 1.05);
		addDueDate("01/24/2024 01:00:00", 1.0);
		addDueDate("01/31/2024 01:00:00", 0.9);
		addDueDate("02/07/2024 01:00:00", 0.75);
        addFeature("Screenshots enclosed", 3, new DocumentEnclosedTestCase());
		addJUnitTestSuite(S24Assignment0Suite.class);
