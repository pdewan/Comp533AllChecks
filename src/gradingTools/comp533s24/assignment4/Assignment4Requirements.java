...
public class Assignment4Requirements extends AJUnitProjectRequirements {
	public Assignment4Requirements() {
		...
		addDueDate("03/30/2024 01:00:00", 1.05);
		addDueDate("04/03/2024 01:00:00", 1.0);
		addDueDate("04/10/2024 01:00:00", 0.9);
		addDueDate("04/17/2024 01:00:00", 0.7);
		
		addJUnitTestSuite(S24Assignment4Suite.class);
